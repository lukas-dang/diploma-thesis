...
\begin{itemize}
	\item \href[]{https://api.propublica.org/}{\color{blue}{prorepublica}} \cite{propublica}
	 - ProPublica je nezávislá, nezisková redakce.
	\item 	\href[]{https://theunitedstates.io/}{\color{blue}{theunitedstates}}\cite{unitedstates} - @unitedstates je projekt poskytující data ohledně Spojených Států veřejností a pro veřejnost.
	\item \href[]{https://www.congress.gov/}{\color{blue}{congress}} \cite{congress} - Congress.gov je oficiální portál pro informace z Kongresu a orgánů státní správy.
	\item \href[]{https://api.open.fec.gov/}{\color{blue}{openfec}} \cite{openfec} - OpenFEC je oficiální portál vlády Spojených Států.
\end{itemize}
